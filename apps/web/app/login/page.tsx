    ...
    <div className="mx-auto mt-16 max-w-sm">
      <div className="mb-8 text-center">
        ...
        <h1 className="text-3xl font-extrabold tracking-tight text-white">
          Social <span className="neon-text">Poster</span>
        </h1>
        <p className="mt-2 text-sm text-neutral-400">Welcome back. Your audience missed you. ⚡</p>
      </div>
      <form onSubmit={submit} className="card space-y-4">
        ...
        <p className="text-center text-sm text-neutral-400">
          New here? <Link className="font-bold text-[#39ff14] hover:underline" href="/register">Create an account — it's free</Link>
        </p>
      </form>
    </div>
  );
